...
stereo_depth_root = "/c20250502/wangyushen/Datasets/kitti/semantickitti/dataset/depth"
camera_used = ['left']
    ...
    occ_encoder_backbone=dict(
        ...
        global_aggregator=dict(
            ...
            global_encoder_backbone=dict(
                ...
                init_cfg=dict(
                    type="Pretrained",
                    checkpoint="/c20250502/wangyushen/Weights/cgformer/swin_tiny_patch4_window7_224.pth",
                ),
            ),
            global_encoder_neck=dict(
                ...
                num_outs=3,
                norm_cfg=dict(
                    type="BN2d", requires_grad=True, track_running_stats=False
                ),
                act_cfg=dict(type="ReLU", inplace=True),
...
load_from = "/c20250502/wangyushen/Weights/cgformer/efficientnet-seg-depth.pth"
